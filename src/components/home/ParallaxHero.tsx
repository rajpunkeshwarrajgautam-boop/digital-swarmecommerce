...
export function ParallaxHero() {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-blue-400/10 blur-[100px]"
        animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.8, 0.5] }}
        transition={{ duration: 10, repeat: Infinity }}
      />
      <motion.div 
        className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-pink-400/10 blur-[120px]"
        animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3] }}
        transition={{ duration: 12, repeat: Infinity, delay: 2 }}
      />

      <div className="container relative z-30 flex flex-col lg:flex-row items-center justify-between min-h-screen pt-32 pb-12 gap-12 px-6">
        ...
        >
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold text-[#111827] leading-[1.1] tracking-tight uppercase">
            Launch Your <br/>
        ...
        <motion.div
          className="relative w-full lg:w-1/2 flex items-center justify-center lg:h-[600px] mt-12 lg:mt-0"
          style={{ y: y1 }}
        >
          <motion.div
          ...
          >
            ...
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 bg-white rounded-[2rem] clay-card p-6 flex flex-col gap-5 z-20">
            ...
            <motion.div 
              className="absolute -right-6 top-24 w-24 h-24 bg-white rounded-3xl clay-card z-30 flex items-center justify-center"
              animate={{ y: [0, -12, 0] }}
            ...
            <motion.div 
              className="absolute -left-8 bottom-32 w-20 h-20 bg-white rounded-full clay-card z-30 flex items-center justify-center p-4"
              animate={{ y: [0, 15, 0] }}
            ...
            >
              <div className="w-full h-full bg-pink-100 rounded-full flex items-center justify-center shadow-inner">
                <div className="w-5 h-5 bg-[#f26496] rounded-full shadow-md" />
              </div>
            </motion.div>

            <motion.div 
              className="absolute right-12 -bottom-6 w-16 h-16 bg-white rounded-2xl clay-card z-10 flex items-center justify-center"
