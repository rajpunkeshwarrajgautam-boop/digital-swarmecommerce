    ...
    <ClerkProvider
      appearance={{
        variables: { 
          ...
          colorInputText: '#CCFF00',
        },
        elements: {
          formButtonPrimary: "bg-[#CCFF00] text-black hover:bg-white transition-all border-4 border-black shadow-[4px_4px_0_#000] font-black uppercase italic",
          card: "bg-black border-4 border-[#CCFF00] shadow-[10px_10px_0_#CCFF00] rounded-none",
          ...
          socialButtonsBlockButton: "bg-white border-4 border-black rounded-none transition-all hover:bg-[#CCFF00]",
          socialButtonsBlockButtonText: "text-black font-black uppercase tracking-tighter",
          socialButtonsBlockButtonArrow: "text-black",
          formFieldLabel: "text-white font-black uppercase text-[10px] tracking-widest mb-1",
          formFieldInput: "bg-black border-2 border-[#CCFF00] text-[#CCFF00] focus:ring-1 focus:ring-[#CCFF00] rounded-none h-12 font-mono font-bold",
